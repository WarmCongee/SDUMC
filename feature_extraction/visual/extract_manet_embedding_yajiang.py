...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name',    type=str, default='manet',        choices=['resnet50_ferplus_dag', 'senet50_ferplus_dag', 'manet'])
    parser.add_argument('--face_dir',    type=str, default=None, help='face root dir')
    ...
    save_name = f"manetface_{params.feature_level[:3]}_{face_dir.split('/')[-1]}"
    save_dir = os.path.join(config_backup.PATH_TO_FEATURES['MER2023'], save_name)
