...
if __name__ == '__main__':
    ...
    face_dir = config_backup.PATH_TO_RAW_FACE[params.dataset]
    save_dir = os.path.join(config_backup.PATH_TO_FEATURES[params.dataset], f'imagenet_{params.feature_level[:3]}')
