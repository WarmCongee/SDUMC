...
class TFN(nn.Module):
    ...
    def __init__(self, args):
        ...
        text_dim    = 4096 #args.text_dim
        audio_dim   = 1024 #args.audio_dim
        video_dim   = 1024 #args.video_dim
        output_dim1 = args.output_dim1
        output_dim2 = args.output_dim2
        dropout= args.dropout
        self.hidden_dim = 128# args.hidden_dim
    ...
    def forward(self, batch):
        ...
        audio_h = self.audio_encoder(batch[0])
        text_h  = self.text_encoder(batch[1])
        video_h = self.video_encoder(batch[2])
